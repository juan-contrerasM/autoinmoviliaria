...
public class Automoviliaria {
	...
	public Emp guardarEmpleado(String documento, String nombre, String apellido, LocalDate nacimiento, String email,
			String contrasenia, String telefono, UserType userType) {
		Emp nn = new Emp();
		nn.setDocument("12");
		nn.setName("hi");
